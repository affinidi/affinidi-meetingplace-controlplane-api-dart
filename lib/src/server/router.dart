...
Router createRouter(ApplicationFacade facade) {
  return Router()
    ...
    ..post(
      '/v1/authenticate',
      publicPipeline(authAuthenticate, facade),
    )
    ..post(
      '/v1/authenticate/challenge',
      publicPipeline(authChallenge, facade),
    )

    // offer routes
    ..post(
      '/v1/register-offer',
      privatePipeline(registerOffer, facade),
    )
    ..post(
    ...
    ..post(
      '/v1/deregister-offer',
      privatePipeline(deregisterOffer, facade),
    )
    ..post(
      '/v1/query-offer',
      privatePipeline(queryOffer, facade),
    )
    ..post(
      '/v1/accept-offer',
      privatePipeline(acceptOffer, facade),
    )
    ..post(
      '/v1/accept-offer-group',
      privatePipeline(acceptOfferGroup, facade),
    )
    ..post(
      '/v1/check-offer-phrase',
      privatePipeline(checkOfferPhrase, facade),
    )
    ...
    ..post(
      '/v1/register-device',
      privatePipeline(registerDevice, facade),
    )
    ...
    ..post(
      '/v1/notify-channel',
      privatePipeline(notifyChannel, facade),
    )
    ..post(
      '/v1/notify-acceptance',
      privatePipeline(notifyAcceptance, facade),
    )
    ..post(
    ...
    ..post(
      '/v1/group-add-member',
      privatePipeline(groupAddMember, facade),
    )
    ..post(
      '/v1/group-delete',
      privatePipeline(groupDelete, facade),
    )
    ..post(
    ...
    ..post(
      ...
      privatePipeline(groupSendMessage, facade),
    )

    // outreach
    ..post(
      '/v1/notify-outreach',
      privatePipeline(notifyOutreach, facade),
    )

    // oob
    ..post(
      '/v1/create-oob',
      publicPipeline(createOob, facade),
    )
    ..get(
      '/v1/oob/<id>',
      publicPipeline(getOob, facade),
    );
}
