...
class GroupAddMemberRequestValidator extends LucidValidator {
  GroupAddMemberRequestValidator() {
    ...
    ruleFor((request) => request['memberDid'] as String?, key: 'memberDid')
        .notEmptyOrNull();

    ruleFor((request) => request['acceptOfferAsDid'] as String?,
            key: 'acceptOfferAsDid')
        .notEmptyOrNull();

    ruleFor((request) => request['reencryptionKey'] as String?,
            key: 'reencryptionKey')
        .notEmptyOrNull();

    ruleFor((request) => request['publicKey'] as String?, key: 'publicKey')
        .notEmptyOrNull();
  }
}
