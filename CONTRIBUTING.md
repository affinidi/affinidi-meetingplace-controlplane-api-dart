# Contributing to Affinidi Control Plane API

When contributing to this repository, please first discuss the change you wish to make by creating a new issue.

### Requirements

- [Dart v3 or higher](https://dart.dev)
- [Docker](https://www.docker.com/)

### Running the API Server

Refer to the options of [setting up Control Plane API server](https://github.com/affinidi/affinidi-meetingplace-controlplane-api-dart/blob/main/README.md#setting-up-api-server).
